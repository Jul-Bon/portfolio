...
<div id="page" class="site">
    ...
    <header id="masthead" class="site-header">
        <div class="top_navigation container">
        ...
        <div class="main_banner"
             style="background: url('<?php echo get_theme_mod('banner_background'); ?>') no-repeat top/cover">
            <div class="container">
                <div class="main_headline wow fadeInDown" data-wow-duration="3s">
